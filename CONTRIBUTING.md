...
Thank you for your interest in contributing to Velonetics-OTEL, there are several ways
you can contribute and make this project more awesome, please see below:

## Reporting an Issue

If you believe you have found an issue with the code please do not hesitate to file an issue in [Github](https://github.com/velonetics/velonetics-otel/issues). When
...
2. [Fork the project](https://github.com/velonetics/velonetics-otel/fork)
...
using the following command:
    ...
    git remote add upstream https://github.com/velonetics/velonetics-otel.git
